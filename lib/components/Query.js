...
var Query = /*#__PURE__*/function (_PureComponent) {
  ...
  _createClass(Query, [{
    ...
    value: function _updateActions(props) {
      ...
      this.actions = (0, _stuff.bindActionCreators)(_objectSpread(_objectSpread(_objectSpread({}, actions.tree), actions.group), actions.rule), config, dispatch);
    }
  }, {
    key: "onPropsChanged",
    ...
    value: function onPropsChanged(nextProps) {
      ...
      if (isTreeChanged) {
        ...
        return Promise.resolve().then(function () {
          _this3.state.store.dispatch(actions.tree.setTree(nextProps, validatedTree));
        });
      }
    }
  }, {
